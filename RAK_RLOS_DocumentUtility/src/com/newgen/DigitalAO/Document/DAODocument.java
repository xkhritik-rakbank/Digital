...
public class DAODocument implements Runnable {	
	...
	public void run()
	{
		...
		try
		{
			...
			fromMailID =DAODocumentCofigParamMap.get("FromMailID");
			DAODocumentLog.mLogger.debug("FromMailID "+fromMailID);
			toMailID =DAODocumentCofigParamMap.get("ToMailID");
			mailSubject = DAODocumentCofigParamMap.get("MailSubject");
			MailStr = DAODocumentCofigParamMap.get("MailBody");
			
			ProcessdefID = DAODocumentCofigParamMap.get("ProcessdefID");
			DAODocumentLog.mLogger.debug("ProcessdefID "+ProcessdefID);
	...
	private void startDAODocumentUtility() throws Exception
	{
								...
								if(foldername.equalsIgnoreCase(workItemName))
								{
										...
										if (listOfDoc.isFile())
										{
											...
											try{
												...
												*/
												...
												if (strDocumentName.contains("W9_Form"))
													DocNameAsProcess = "W9_Form";
												else if(strDocumentName.contains("W8_Form"))
													DocNameAsProcess = "W8_Form";
												else if(strDocumentName.contains("Passport_FirstPage"))
													DocNameAsProcess = "Passport_FirstPage";
												else if(strDocumentName.contains("Passport_LastPage"))
													DocNameAsProcess = "Passport_LastPage";
												else if(strDocumentName.contains("VISA"))
													DocNameAsProcess = "VISA";
												else if(strDocumentName.contains("EMID_Front"))
													DocNameAsProcess = "EMID_Front";
												else if(strDocumentName.contains("EMID_Back"))
													DocNameAsProcess = "EMID_Back";
												else if(strDocumentName.contains("Personal_Bank_Statement_UAE"))
													DocNameAsProcess = "Personal_Bank_Statement_UAE";
												else if(strDocumentName.contains("PaySlip"))
													DocNameAsProcess = "PaySlip";
												else if(strDocumentName.contains("Company_Bank_Statement"))
													DocNameAsProcess = "Company_Bank_Statement";
												else if(strDocumentName.contains("Title_Deed"))
													DocNameAsProcess = "Title_Deed";
												else if(strDocumentName.contains("Tenancy_Contract"))
													DocNameAsProcess = "Tenancy_Contract";
												else if(strDocumentName.contains("Cheque_Copies"))
													DocNameAsProcess = "Cheque_Copies";
												else if(strDocumentName.contains("SWIFT_Advice"))
													DocNameAsProcess = "SWIFT_Advice";
												else if(strDocumentName.contains("Other_Documents"))
													DocNameAsProcess = "Other_Documents";
												else if(strDocumentName.contains("Trade_License"))
													DocNameAsProcess = "Trade_License";
												else if(strDocumentName.contains("Business_ownership_Documents"))
													DocNameAsProcess = "Business_ownership_Documents";
												else if(strDocumentName.contains("Sales_Purchase_Invoice"))
													DocNameAsProcess = "Sales_Purchase_Invoice";
												else if(strDocumentName.contains("Shipment_Copies"))
													DocNameAsProcess = "Shipment_Copies";
												else if(strDocumentName.contains("agreements_contracts"))
													DocNameAsProcess = "agreements_contracts";
												else if(strDocumentName.contains("Audited_Financial_statements"))
													DocNameAsProcess = "Audited_Financial_statements";
												else if(strDocumentName.contains("Bonus_letter"))
													DocNameAsProcess = "Bonus_letter";
												else if(strDocumentName.contains("Company_ID"))
													DocNameAsProcess = "Company_ID";
												else if(strDocumentName.contains("VAT_payment_receipts"))
													DocNameAsProcess = "VAT_payment_receipts";
												else if(strDocumentName.contains("Delivery_receipt"))
													DocNameAsProcess = "Delivery_receipt";
												else if(strDocumentName.contains("Previous_passport_and_visa_copies"))
													DocNameAsProcess = "Previous_passport_and_visa_copies";
												else if(strDocumentName.contains("Entry_and_exit_stamps_from_current_or_previous_pas"))
													DocNameAsProcess = "Entry_and_exit_stamps_from_current_or_previous_pas";
												else if(strDocumentName.contains("Generate_template"))
													DocNameAsProcess = "Generate_template";
												else if(strDocumentName.contains("KYC_Form"))
													DocNameAsProcess = "KYC_Form";
												else if(strDocumentName.contains("generate_temp"))
													DocNameAsProcess = "generate_temp";
												else if(strDocumentName.contains("DAO_Template_kyc"))
													DocNameAsProcess = "DAO_Template_kyc";
												else if(strDocumentName.contains("MOI_certificate"))
													DocNameAsProcess = "MOI_certificate";
												else if(strDocumentName.contains("Wet_signature_form"))
													DocNameAsProcess = "Wet_signature_form";
												else if(strDocumentName.contains("Application_form"))
													DocNameAsProcess = "Application_form";
												else if(strDocumentName.contains("Signature"))
													DocNameAsProcess = "Signature";
												else if(strDocumentName.contains("Proof_of_delivery"))
													DocNameAsProcess = "Proof_of_delivery";
												else if(strDocumentName.contains("single_pager"))
													DocNameAsProcess = "single_pager";
												else if(strDocumentName.contains("Personal_Bank_Statement_HomeCountry"))
													DocNameAsProcess = "Personal_Bank_Statement_HomeCountry";
												else if(strDocumentName.contains("Risk_Score_Details"))
													DocNameAsProcess = "Risk_Score_Details";
												else if(strDocumentName.contains("DAO_Firco_Template"))
													DocNameAsProcess = "DAO_Firco_Template";
												else if(strDocumentName.contains("HOD_Approval"))
													DocNameAsProcess = "HOD_Approval";
												else if(strDocumentName.contains("Labour_Contract"))
													DocNameAsProcess = "Labour_Contract";
												else if(strDocumentName.contains("Employment_Offer_letter"))
													DocNameAsProcess = "Employment_Offer_letter";
												else if(strDocumentName.contains("WPS_Receipt"))
													DocNameAsProcess = "WPS_Receipt";
												else if(strDocumentName.contains("Memorandum"))
													DocNameAsProcess = "Memorandum";
												else if(strDocumentName.contains("Articles_of_ Association") || strDocumentName.contains("Articles_of_Association"))
													DocNameAsProcess = "Articles_of_ Association";
												else if(strDocumentName.contains("Certificate_of_Incorporatipon"))
													DocNameAsProcess = "Certificate_of_Incorporatipon";
												else if(strDocumentName.contains("Share_Certification"))
													DocNameAsProcess = "Share_Certification";
												else if(strDocumentName.contains("Salary_Certificate"))
													DocNameAsProcess = "Salary_Certificate";
												else
													DocNameAsProcess = "Other_Documents";
											...
											{
												DAODocumentLog.mLogger.info("workItemName: "+workItemName+" strfullFileName : "+strfullFileName);
												DAODocumentLog.mLogger.info("strExtension: Before PNG: "+strfullFileName);
												strExtension="JPG";
												DAODocumentLog.mLogger.info("strExtension: After PNG: "+strfullFileName);
											}
											...
											DAODocumentLog.mLogger.info("workItemName: "+workItemName+" DocNameAsProcess : "+DocNameAsProcess+" strExtension : "+strExtension);
									...
									try
									{
										if("0".equalsIgnoreCase(statusXML)){
											...
											DAODocumentLog.mLogger.info("updateExternalTable -- "+get_timestamp());
											historyCaller(workItemName,decisionToUpdate,Remarks_dec);
											DAODocumentLog.mLogger.info("historyCaller -- "+get_timestamp());
											doneWorkItem(workItemName, "");
											DAODocumentLog.mLogger.info("doneWorkItem -- "+get_timestamp());
											...
											doneWorkItem(workItemName, "");
											DAODocumentLog.mLogger.info("doneWorkItem -- "+get_timestamp());
											DAODocumentLog.mLogger.info("Moving WI in case failure to attach docs ");
											sendMail(cabinetName,sessionId,workItemName,jtsIP,jtsPort,ErrorMsg,iNoOfTries);
										}
									}
									catch (Exception e)
									{
									...
									ErrorFlag = false;
									DAODocumentLog.mLogger.info("Done WI after folder match:: ");
									//doneWorkItem(workItemName, "");
								}
								else
								{
				...
				try
				{
					if(ErrorFlag)
					{
						...
						if (iNoOfTries > iMaxNoOfTries)
						{
							...
							DAODocumentLog.mLogger.info("Done WI when no folder match:: ");
							doneWorkItem(workItemName, ""); 
							DAODocumentLog.mLogger.info("Moving WI after max tries exceeds");
							sendMail(cabinetName,sessionId,workItemName,jtsIP,jtsPort,ErrorMsg,iNoOfTries);
						}
					}
				}
	...
	private String getEntryDatetimefromDB(String workItemName)
	{
		...
		while(sessionCheckInt<loopCount)
		{
			...
			{
				XMLParser objXMLParser = new XMLParser();
				String sqlQuery = "select entry_date_time from NG_DAO_EXTTABLE with(nolock) where WI_NAME='"+workItemName+"'";
		...
		if (mainCodeEntryDate.equalsIgnoreCase("0")) 
		{
			try 
			{
				entryDatetimeAttachCust = CommonMethods.getTagValues(outputXMLEntryDate, "entry_date_time");
	...
	public  void sendMail(String cabinetName, String sessionId ,String wiName,String jtsIp,String jtsPort,String ErrorMsg,int iNoOfTries)throws Exception
    {
        XMLParser objXMLParser = new XMLParser();
        String sInputXML="";
        String sOutputXML="";
        ...
        while(sessionCheckInt<loopCount)
        {
            try
            {
            	DAODocumentLog.mLogger.info("workitem name to send mail---"+workItemName);
            	DAODocumentLog.mLogger.info("ErrorMsg to send mail---"+ErrorMsg);
            	DAODocumentLog.mLogger.info("iNoOfTries to send mail---"+iNoOfTries);
            	
            	String FinalMailStr = MailStr.toString().replace("<WI_NAME>",workItemName).replace("<attach_try_no>",String.valueOf(iNoOfTries))
            	.replace("<errormsg>",ErrorMsg);
            	DAODocumentLog.mLogger.info("finalbody: "+FinalMailStr);
            	...
            	String strValues="'"+fromMailID+"','"+toMailID+"','"+mailSubject+"','"+FinalMailStr+"','text/html;charset=UTF-8','1','N','CUSTOM','TRIGGER','"+CommonMethods.getdateCurrentDateInSQLFormat()+"','"+ProcessdefID+"','"+workItemName+"','1','1','0'";
				...
				sInputXML = "<?xml version=\"1.0\"?>" +
                        ...
                        "</APInsert_Input>";
                DAODocumentLog.mLogger.info("Mail Insert InputXml::::::::::\n"+sInputXML);
                sOutputXML =WFNGExecute(sInputXML, jtsIP, Integer.parseInt(jtsPort), 0 );
                DAODocumentLog.mLogger.info("Mail Insert OutputXml::::::::::\n"+sOutputXML);
                objXMLParser.setInputXML(sOutputXML);
                mainCodeforAPInsert=objXMLParser.getValueOf("MainCode");
            ...
            {
                e.printStackTrace();
                DAODocumentLog.mLogger.error("Exception in Sending mail", e);
                sessionCheckInt++;
                waiteloopExecute(waitLoop);
                continue;
            }
            if (mainCodeforAPInsert.equalsIgnoreCase("11")) 
            {
                DAODocumentLog.mLogger.info("Invalid session in Sending mail");
                sessionCheckInt++;
                //ThreadConnect.sessionId = ThreadConnect.getSessionID(cabinetName, jtsIP, jtsPort, userName,password);
                sessionId=CommonConnection.getSessionID(DAODocumentLog.mLogger, true);
                continue;
            }
            else
            {
        ...
        if(mainCodeforAPInsert.equalsIgnoreCase("0"))
        {
            DAODocumentLog.mLogger.info("mail Insert Successful");
            System.out.println("Mail Insert Successful for "+workItemName+" in table WFMAILQUEUETABLE");
        }
        else
        {
            DAODocumentLog.mLogger.info("mail Insert Unsuccessful");
            System.out.println("Mail Insert Unsuccessful for "+workItemName+"in table WFMAILQUEUETABLE");
        }
    }
