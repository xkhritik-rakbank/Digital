...
public final class DCCDispatchLog 
{
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DigitalCC_Dispatch_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_Dispatch_Logs/"+logDateFormat.format(date)+"/DCC_Dispatch_Log.xml";
