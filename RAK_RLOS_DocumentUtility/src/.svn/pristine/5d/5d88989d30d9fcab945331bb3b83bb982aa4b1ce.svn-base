...
public final class AppFormLog 
{
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "Falcon_AppForm_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/Falcon_AppForm_Logs/"+logDateFormat.format(date)+"/Falcon_AppForm_Log.xml";
