...
public final class DAODocumentLog 
{
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DigitalAO_Document_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAO_Document_Logs/"+logDateFormat.format(date)+"/DAO_Document_Log.xml";
