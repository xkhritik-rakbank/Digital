...
public final class FalconDocumentLog 
{
	private static String loggerName = "FalconDocumentLogger";
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "Falcon_Document_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/Falcon_Document_Logs/"+logDateFormat.format(date)+"/Falcon_Document_Log.xml";
