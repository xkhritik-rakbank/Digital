		...
		while(sessionCheckInt<loopCount)
		{
			try
			{
				if(workItemName!=null)
				{
					...
					String columns="wi_name,workstep,Decision,decision_date_time,Remarks,user_name";
					...
					String values = "'" + WINAME +"'" + "," + "'" + WSNAME +"'" + "," + "'" + decision +"'" + ","  + "'"+formattedActionDateTime+"'" + "," + "'" + remarks +"'" + "," +  "'" + lusername + "'";
