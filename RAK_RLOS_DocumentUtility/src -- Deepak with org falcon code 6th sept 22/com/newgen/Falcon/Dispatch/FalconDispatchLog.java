...
public final class FalconDispatchLog 
{
	private static String loggerName = "FalconDispatchLogger";
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "Falcon_Dispatch_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/Falcon_Dispatch_Logs/"+logDateFormat.format(date)+"/Falcon_Dispatch_Log.xml";
