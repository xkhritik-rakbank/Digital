...
public final class DCCAppFormLog 
{
	private static String loggerName = "AppFormLogger";
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DigitalCC_AppForm_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_AppForm_Logs/"+logDateFormat.format(date)+"/DCC_AppForm_Log.xml";
		...
		{
			System.out.println("Exception in creating dynamic log for application form :"+e);
			e.printStackTrace();
		}
    }
}
