...
public final class DCCDocumentLog 
{
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DigitalCC_Document_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_Document_Logs/"+logDateFormat.format(date)+"/DCC_Document_Log.xml";
