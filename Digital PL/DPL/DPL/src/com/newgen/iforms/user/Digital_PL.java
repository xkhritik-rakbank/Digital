...
public class Digital_PL implements IFormListenerFactory{

	private static String loggerName = "DPLLogger";
	private static String processName = "DPL";
	...
	public static void setLogger() 
	{
		try 
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "CustomConfig"+ File.separator+"DPL"+ File.separator+ "log4j_DPL.properties"));
