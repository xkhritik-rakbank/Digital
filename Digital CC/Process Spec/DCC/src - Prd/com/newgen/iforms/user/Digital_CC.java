...
public class Digital_CC implements IFormListenerFactory{

	private static String loggerName = "DCCLogger";
	private static String processName = "DCC";
	...
	public static void setLogger() 
	{
		try 
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "CustomConfig"+ File.separator+"DCC"+ File.separator+ "log4j_DCC.properties"));
