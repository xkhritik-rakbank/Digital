...
"</EE_EAI_MESSAGE>";
		...
		String DCC_FTS_update="<EE_EAI_MESSAGE>"+"\n"+
				...
				"        <MessageId>RPA7BYOX1683276941720</MessageId>"+"\n"+
				"        <Extra1>REQ||RAK.VTUSER</Extra1>"+"\n"+
				"        <Extra2>2023-05-05T12:55:41.732+05:30</Extra2>"+"\n"+
				"    </EE_EAI_HEADER>"+"\n"+
				"    <UpdateWorkitemReq>"+"\n"+
				"        <ProcessName>Digital_CC</ProcessName>"+"\n"+
				...
				"            <Attribute>"+"\n"+
				"                <Name>WINUMBER</Name>"+"\n"+
				"                <Value>DCC-0000030038-process</Value>"+"\n"+
				"            </Attribute>"+"\n"+
				"            <Attribute>"+"\n"+
				"                <Name>Prospect_id</Name>"+"\n"+
				"                <Value>124868</Value>"+"\n"+
				...
				"            </Attribute>"+"\n"+
				"            <Attribute>"+"\n"+
				"                <Name>Addn_Perfios_EMI_1</Name>"+"\n"+
				"                <Value>2500.0</Value>"+"\n"+
				"            </Attribute>"+"\n"+
				"            <Attribute>"+"\n"+
				"                <Name>Addn_Perfios_EMI_2</Name>"+"\n"+
				"                <Value>2500.0</Value>"+"\n"+
				"            </Attribute>"+"\n"+
				"            <Attribute>"+"\n"+
				"                <Name>Addn_Perfios_EMI_3</Name>"+"\n"+
				"                <Value>8000.0</Value>"+"\n"+
				"            </Attribute>"+"\n"+
				"            <Attribute>"+"\n"+
		...
		String DPL_CREATE="<EE_EAI_MESSAGE>"+
				"<EE_EAI_HEADER>"+
				"<MsgFormat>CUSTOMER_SR</MsgFormat>"+
				"<MsgVersion>0000</MsgVersion>"+
				"<RequestorChannelId>EBC.WBA</RequestorChannelId>"+
				...
				"<ReturnCode>0000</ReturnCode>"+
				"<ReturnDesc>0000</ReturnDesc>"+
				"<MessageId>UAT4_05862248</MessageId>"+
				"<Extra1>REQ||RAK.cntrlm</Extra1>"+
				"<Extra2>2023-02-07T09:23:17.832 05:30</Extra2>"+
				"</EE_EAI_HEADER>"+
				"<CreateWorkitemReq>"+
				"<ProcessName>Digital_PL</ProcessName>"+
				"<SubProcess>Digital_PL</SubProcess>"+
				"<SubProcessName>Digital_PL</SubProcessName>"+
				"<InitiateAlso>Y</InitiateAlso>"+
				"<Attributes>"+
				"<Attribute>"+
				"<Name>IsNTB</Name>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>IsAccountCreated</Name>"+
				"<Value>Y</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>IsFIRCOHit</Name>"+
				"<Value>N</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>IsFTSReq</Name>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>IsDBCardReq</Name>"+
				"<Value>Y</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>AECBconsent</Name>"+
				"<Value>Y</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>IsBLACKLIST</Name>"+
				"<Value>N</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				...
				"<Attribute>"+
				"<Name>DOB</Name>"+
				"<Value>1995-29-06</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>MobileNo</Name>"+
				"<Value>971503456865</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>EmailID</Name>"+
				"<Value>SIDEVA@RAKBANK.AE</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>PassportNumber</Name>"+
				"<Value>AZ6363</Value>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>PurposeOfLoan</Name>"+
				"<Value>Remittances</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>RequestedLoanTenor</Name>"+
				"<Value>48</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>FirstRepaymentDate</Name>"+
				"<Value>2024-03-03</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>StartofJob</Name>"+
				"<Value>Y</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>SalaryTransferAccReq</Name>"+
				"<Value>Y</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>SalaryIBAN</Name>"+
				"<Value>070331234567890123456</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>CustomerDeclaredMonthlyIncome</Name>"+
				"<Value>80000</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>DateOfSalary</Name>"+
				"<Value>2023-03-03</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>TotalMonthlyHouseholdIncome</Name>"+
				"<Value>80000</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>NoOfEarningMembers</Name>"+
				"<Value>2</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>NoOfDependants</Name>"+
				"<Value>1</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>LifestyleExpenses</Name>"+
				"<Value>100</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>Bills</Name>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>RentOrMortgage</Name>"+
				"<Value>8000</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>DualNationality</Name>"+
				"<Value>N</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>TaxResidentExceptUAE</Name>"+
				"<Value>N</Value>"+
				"</Attribute>"+
				"</Attributes>"+
				"<DemographicDetails>"+
				...
				"</Attribute>"+
				"<Attribute>"+
				"<Name>HouseApartmentNo</Name>"+
				"<Value>23</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>BuildingApartmentName</Name>"+
				"<Value>Block1</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>StreetLocation</Name>"+
				"<Value>Corner</Value>"+
				"</Attribute>"+
				"<Attribute>"+
				"<Name>CityTown</Name>"+
		...
		System.out.println("message : "+DCC_FTS_update);
		String response =new CreateWorkitem().getResponseOffshore(DCC_FTS_update);
